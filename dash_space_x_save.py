...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.H4('success & payload scatter plot'),
...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        labels = ['Failed', 'Successful'] # Assuming 0 is for Failed and 1 is for Successful
        fig = px.pie(df_grouped, values='counts', names='class', title=f'Launch Outcomes for {entered_site}')
